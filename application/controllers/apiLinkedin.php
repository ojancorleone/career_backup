...
class ApiLinkedin extends CI_Controller {
    ...
    public function index($REFERRED_BY=0) { 
		$this->load->library('linkedin', array(
            'access' => "81fkzqze6consk",//"<your Consumer Key / API Key goes here>",
            'secret' => "XoBpm3oEw2CGhJjn",//"<your Consumer Secret / Secret Key goes here>",
            'callback' => "http://localhost/recruitment-dev/apiLinkedin/receiver"//"<write here your site name>/receiver" 
        ));
