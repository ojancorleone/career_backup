...
class M_admin_company extends CI_Model {
	...
	function add($company_name,$company_nickname,$address,$phone_no,$fax_no,$zip_code,$email_support,$status,$upd,$lup,$file_img){
	...
	public function upload_img_company( $file_img ,$id ){

		$data	= array("logo" => $file_img );
		$filter = array("filter" => "id=".$id."");

		$result = $this->Api->put_table('m_tenant' , $data, $filter);
		return false;
	}
