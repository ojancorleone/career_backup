...
class Company_configuration extends CI_Controller {

	function __construct()
    {
        parent::__construct();
		$this->load->model('M_company_configuration');
    }
	...
	public function json_list(){
			...
			$data =  $this->M_company_configuration->list_data($length,$start,$search,$order,$dir,$column_name);
	...
	public function view_detail(){
		...
		if($this->session->userdata('is_logged_in') == true){
			...
			if($act=="Edit"){
				...
				$detail_data = $this->M_company_configuration->detail_data($id);
	...
	public function forms_submit(){
		...
		if($this->session->userdata('is_logged_in') == true){
			...
			if($act=="Edit"){
				$submit = $this->M_company_configuration->edit($id,$company_name,$company_nickname,$address,$phone_no,$fax_no,$zip_code,$email_support,$status,$upd,$lup);
			}else{
				$submit = $this->M_company_configuration->add($company_name,$company_nickname,$address,$phone_no,$fax_no,$zip_code,$email_support,$status,$upd,$lup);
			}
	...
	public function change_status(){
		...
		if($this->session->userdata('is_logged_in') == true){
			...
			$update_status 	= $this->M_company_configuration->update_status($id,$status,$upd,$lup);
	...
	public function del_item(){
		...
		if($this->session->userdata('is_logged_in') == true){
			...
			$deleted_item = $this->M_company_configuration->deleted_item($id,$status,$upd,$lup);
