                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="vendor_name">Name</label>
                                                <input class="form-control" type="text" name="vendor_name" id="vendor_name" value="{vendor_name}" data-validation="[NOTEMPTY]" placeholder="Vendor Name">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="vendor_nickname">Nickname</label>
                                                <input class="form-control" type="text" name="vendor_nickname" id="vendor_nickname" value="{vendor_nickname}" data-validation="[NOTEMPTY]" placeholder="Nickname">
                                        </div>
                                    </div>
                                </div>
