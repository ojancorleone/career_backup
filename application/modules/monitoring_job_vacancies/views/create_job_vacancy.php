...
.form-wizard ::-moz-selection { background: #017fe0; color: #fff; text-shadow: none; }
.form-wizard ::selection { background: #017fe0; color: #fff; text-shadow: none; }
...
/*.form-control option:hover, .form-control option:checked  {
    box-shadow: 0 0 10px 100px #017fe0 inset;
}
...
.form-wizard label span { color:#017fe0; }
...
.form-wizard-buttons { text-align: right; padding-top: 20px; padding-bottom: 20px; }

.form-wizard .input-error { border-color: #017fe0;}
                        ...
                        <form role="form" action="" method="post">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="job_code" placeholder="Job Code" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="state_region" placeholder="State/Region" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control select2" name="show_salary">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="maximum_salary" placeholder="Maximum Salary" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            <label>Minimum Salary: <span>*</span></label>
                                            <input type="text" name="minimum_salary" placeholder="Minimum Salary" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea name="job_description" id="job_description" placeholder="Job Description" class="form-control summernote" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea name="job_requirements" id="job_requirements" placeholder="Job Description" class="form-control summernote" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="text-black"><strong>Benefits</strong></h5>
                                        <div class="form-group">
                                            <textarea name="benefit" id="benefit" placeholder="Job Description" class="form-control summernote" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control select2" name="employeement_type">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="text-black"><strong>Required Skill</strong></h5>
                                        <div class="form-group">
                                            <textarea name="required_skill" id="required_skill" placeholder="Eg: ASP.net, PHP, React" class="form-control" rows="5" style="height: 100%"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="text-black"><strong>Keywords</strong></h5>
                                        <div class="form-group">
                                            <textarea name="keywords" id="keywords" placeholder="Add Keywords" class="form-control" rows="5" style="height: 100%"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Employee ID" placeholder="Employee ID" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Working Hours" placeholder="Working Hours" class="form-control">
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Bank Name" placeholder="Bank Name" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Holder Name" placeholder="Holder Name" class="form-control">
                                </div>
                                <div class="container-fluid">
                                <div class="row form-inline">
