...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="{base_url}assets/backend/vendors/jquery-steps/demo/css/jquery.steps.css">
    ...
    <script src="{base_url}assets/backend/vendors/jquery-steps/build/jquery.steps.min.js"></script>
...
<body id="menu_style" class="cat__config--horizontal cat__menu-left--colorful cat__config--superclean">
            ...
            <div class="dropdown cat__top-bar__avatar-dropdown">
                <a href="javascript: void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <span class="cat__top-bar__avatar" href="javascript:void(0);">
                        ...
                        echo '<img src="'.base_url().'assets/backend/img/profile/'.$this->session->userdata('tenant_id').'/'.$this->session->userdata('email').'/'.$this->session->userdata('foto').'" />'; 
                        }else{
                        echo '<img src="'.base_url().'assets/backend/modules/core/common/img/avatars/1.jpg" />';
                        }
                        ?>
                    </span>
                </a>
