...
<section class="card">
    <div class="card-header">
        <span class="cat__core__title">
            <strong> Mail Account </strong>
            <a href='main#{page_content}/view_detail' id=$id class='btn btn-icon btn-success btn-rounded mr-2 mb-2 pull-right' data-toggle='tooltip' title='Add' aria-expanded='false'>
